# <p align="center"> The Book Store </p>
  ...
  * [Questions](#questions)
  ...
  ## :wrench: Installation
  <a name="installation">Clone this repo to your local machine. Run ``npm install`` to add all necessary dependencies. Once everything is in place, run ``npm run develop`` to view the application in the development enviroment. </a>
  <br />
  


  ## :desktop_computer: Usage
  <a name="usage">Searching for books using the Google Books API</a>
  <br />
